  ...
  return (
    <section className='w-[80%] xl:w-[85%] flex justify-center items-center flex-col gap-5 py-10'
      ...
      <div className='w-full h-4/6 flex justify-center items-center flex-col lg:flex-row gap-5'>
        ...
        <div className='lg:w-[50%] 2xl:w-[70%] w-full lg:h-[300px] 2xl:h-[450px] md:h-[250px] h-[250px] shadow-lg border-[1px] border-[#AD00FF] bg-gray-300 order-1 lg:order-2' style={{ backgroundImage: 'url("/fotos/ubicacion.png")' }}>
