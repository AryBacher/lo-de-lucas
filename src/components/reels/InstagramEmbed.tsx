...
const InstagramEmbed = ({ href }: InstagramEmbedProps) => {
  ...
  return (
    ...
    >
      <div className="p-4">
        <a
          href="https://www.instagram.com/reel/CtKq7MKg-H-/?utm_source=ig_embed&amp;utm_campaign=loading"
          className="bg-white block text-center no-underline w-full"
          target="_blank"
        ...
        >
          ...
          <div className="pt-2">
            <div className="text-blue-500 font-sans text-sm font-semibold leading-4">
