  ...
  return (
    <section className='mt-10'>
      <div className='w-full h-full flex justify-center items-center flex-col gap-2'>
        ...
        <button className='w-[70%] h-14 bg-[#00960F] flex justify-center items-center flex-row gap-3 mt-4'>
          <span className='text-white text-lg'>Comunicate con nosotros</span>
