  ...
  return (
    ...
    >
      <div className='w-full h-1/6 flex justify-center items-center flex-col gap-2'>
        <Title title='LOS PLATOS FAVORITOS' className='text-[#00084D] w-full xl:h-auto text-3xl font-semibold  text-center' />
      ...
      <article className="w-[85%] sm:w-[35%] lg:w-[25%] flex justify-center items-center ">
        <Button
          className="sm:w-[80%] w-full lg:w-[80%] h-[40px] bg-[#00084D] flex flex-row justify-center items-center gap-4 rounded-xl"
